...
public class UtilsFX {
    ...
    private static final Color[] RUNE_COLORS_RED = { new Color(0xB60707), new Color(0xEE3782), new Color(0xF37B20), new Color(0xFF6722), new Color(0xFF6D30), new Color(0xFF0000) };
    private static final Color[] RUNE_COLORS_GREEN = { new Color(0x015629), new Color(0x0E9C00), new Color(0x010000), new Color(0x01FF00), new Color(0x014C3E)};
    private static final Color[] RUNE_COLORS_BLUE = { new Color(0x060956), new Color(0x012578), new Color(0x0C1556), new Color(0x0100FF), new Color(0x01018C)};
    ...
    public static void doRuneEffects(World world, int x, int y, int z, int colorFlag) {
        if(world.isRemote) {
            ...
            while(cnt > 0) {
                ...
                Thaumcraft.proxy.blockRunes(world, x + UtilsFX.randomOffset(world), y + UtilsFX.randomOffset(world), z + UtilsFX.randomOffset(world),
    ...
    public static void doSmokeEffects(World world, int x, int y, int z, float size) {
        ...
        for (int i = 0; i < count; i++) {
            Minecraft.getMinecraft().effectRenderer.addEffect(
                    new EntitySmokeFX(world, x + 0.5 + UtilsFX.randEffectOffset(world.rand), y + 0.5 + UtilsFX.randEffectOffset(world.rand), z + 0.5 + UtilsFX.randEffectOffset(world.rand),
                            UtilsFX.randEffectOffset(world.rand) * 0.01F, UtilsFX.randEffectOffset(world.rand) * 0.1F, UtilsFX.randEffectOffset(world.rand) * 0.01F, size));
        }
    }
