...
public class ItemCreativeNodeRenderer extends ItemExNodeRenderer {
    ...
    private static final AspectList ASPECTS = new AspectList().add(Aspect.AIR, 50).add(Aspect.FIRE, 50)
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        makeo.gadomancy.client.renderers.item.ItemNodeRenderer.renderNodeItem(
                type,
                item,
                ItemCreativeNodeRenderer.ASPECTS,
                NodeType.values()[item.getItemDamage()],
                null,
                data);
    }
}
