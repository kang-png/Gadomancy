...
public abstract class AuraEffect {
     ...
     *
     * EffectType.ENTITY_EFFECT selects entities within {@link AuraEffect#getRange()} range and fires the Entity-related
     * methods
     *
     * EffectType.BLOCK_EFFECT selects random locations within {@link #getRange()} range and fires
     * {@link #doBlockEffect(net.minecraft.util.ChunkCoordinates, net.minecraft.util.ChunkCoordinates, net.minecraft.world.World)}
     *
     ...
     * @return if the entity should be handled with
     *         {@link #doEntityEffect(net.minecraft.util.ChunkCoordinates, net.minecraft.entity.Entity)}
     */
     ...
     *
     * Defines - the range where entities are collected around the pylon. - the range where blocks are collected around
     * the pylon. - how close the player has to be to get the aura's research
     */
