    ...
    public static void preInit() {
        if (ModConfig.enableAdditionalNodeTypes) {
            try {
                ...
                registry.underlyingIntegerMap.field_148749_a
                        .put(RegisteredBlocks.blockNode, Block.getIdFromBlock(ConfigBlocks.blockAiry));
                registry.underlyingIntegerMap.field_148748_b
                        .set(Block.getIdFromBlock(ConfigBlocks.blockAiry), RegisteredBlocks.blockNode);
                ((BiMap) registry.field_148758_b)
                        .forcePut(RegisteredBlocks.blockNode, registry.field_148758_b.get(ConfigBlocks.blockAiry));
