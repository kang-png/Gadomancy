...
public class RegisteredManipulations {
    ...
    public static NodeManipulatorResult resultBreakCompounds = new NodeManipulatorResult(
            4,
            NodeManipulatorResultHandler.ResultType.NEGATIVE) {
    ...
    public static NodeManipulatorResult resultCombineAspects = new NodeManipulatorResult(
            5,
            NodeManipulatorResultHandler.ResultType.POSITIVE) {
        ...
        public boolean affect(World world, INode node) {
            ...
            if (base.getAspects().length == 2) {
                ...
                NodeManipulatorResultHandler
                        .combine(node.getAspects(), base.getAspects()[0], base.getAspects()[1], addition);
                return true;
            }
            if (base.getAspects().length > 2) {
    ...
    public static NodeManipulatorResult resultIncreaseModifier = new NodeManipulatorResult(
            4,
            NodeManipulatorResultHandler.ResultType.POSITIVE) {
    ...
    public static NodeManipulatorResult resultDecreaseModifier = new NodeManipulatorResult(
            5,
            NodeManipulatorResultHandler.ResultType.NEGATIVE) {
    ...
    public static NodeManipulatorResult resultGainPrimal = new NodeManipulatorResult(
            3,
            NodeManipulatorResultHandler.ResultType.POSITIVE) {
    ...
    public static NodeManipulatorResult resultSwitchType = new NodeManipulatorResult(
            2,
            NodeManipulatorResultHandler.ResultType.NEUTRAL) {
    ...
    public static NodeManipulatorResult resultApplyGrowing = new NodeManipulatorResult(
            1,
            NodeManipulatorResultHandler.ResultType.POSITIVE) {
