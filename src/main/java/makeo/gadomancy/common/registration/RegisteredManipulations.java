...
public class RegisteredManipulations {
    ...
    public static NodeManipulatorResult resultBreakCompounds =
            new NodeManipulatorResult(4, NodeManipulatorResultHandler.ResultType.NEGATIVE) {
                @Override
    ...
    public static NodeManipulatorResult resultCombineAspects =
            new NodeManipulatorResult(5, NodeManipulatorResultHandler.ResultType.POSITIVE) {
                @Override
                public boolean affect(World world, INode node) {
                    AspectList base = node.getAspectsBase();
                    if (base.getAspects().length < 2) return false;
                    if (base.getAspects().length == 2) {
                        ...
                        NodeManipulatorResultHandler.combine(
                                base, base.getAspects()[0], base.getAspects()[1], addition);
                        NodeManipulatorResultHandler.combine(
                                node.getAspects(), base.getAspects()[0], base.getAspects()[1], addition);
                        return true;
                    }
                    if (base.getAspects().length > 2) {
    ...
    public static NodeManipulatorResult resultIncreaseModifier =
            new NodeManipulatorResult(4, NodeManipulatorResultHandler.ResultType.POSITIVE) {
    ...
    public static NodeManipulatorResult resultDecreaseModifier =
            new NodeManipulatorResult(5, NodeManipulatorResultHandler.ResultType.NEGATIVE) {
    ...
    public static NodeManipulatorResult resultGainPrimal =
            new NodeManipulatorResult(3, NodeManipulatorResultHandler.ResultType.POSITIVE) {
                @Override
                public boolean affect(World world, INode node) {
    ...
    public static NodeManipulatorResult resultSwitchType =
            new NodeManipulatorResult(2, NodeManipulatorResultHandler.ResultType.NEUTRAL) {
                @Override
                public boolean affect(World world, INode node) {
                    ...
                    if (random > 38) {
                        if (node instanceof TileExtendedNode) {
                            ...
                            if (!(tNode.getExtendedNodeType() != null
                                    && tNode.getExtendedNodeType().equals(ExtendedNodeType.GROWING))) {
    ...
    public static NodeManipulatorResult resultApplyGrowing =
            new NodeManipulatorResult(1, NodeManipulatorResultHandler.ResultType.POSITIVE) {
                @Override
                public boolean affect(World world, INode inode) {
                    ...
                    boolean isGrowingAlready = node.getExtendedNodeType() != null
                            && node.getExtendedNodeType().equals(ExtendedNodeType.GROWING);
                    ...
                    if (!isGrowingAlready) {
                        ...
                        ResearchHelper.distributeResearch(
                                Gadomancy.MODID.toUpperCase() + ".GROWING",
                                node.getWorldObj(),
                                node.xCoord,
                                node.yCoord,
                                node.zCoord,
