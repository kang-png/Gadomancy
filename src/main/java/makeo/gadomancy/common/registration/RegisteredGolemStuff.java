...
public class RegisteredGolemStuff {
    ...
    public static void init() {
        RegisteredGolemStuff.typeSilverwood = RegisteredGolemStuff
                .registerGolemType("SILVERWOOD", new SilverwoodGolemType());
        ...
        RegisteredGolemStuff.bodyguardCore = RegisteredGolemStuff
                .registerGolemCore("bodyguardCore", new BodyguardGolemCore());

        RegisteredGolemStuff.upgradeRunicShield = RegisteredGolemStuff
                .registerGolemUpgrade(new GolemUpgradeRunicShield());
    }
