...
public class RegisteredResearches {
    ...
    public static void init() {
        ...
        ResearchCategories.registerCategory(
                Gadomancy.MODID, RegisteredResearches.CATEGORY_ICON, RegisteredResearches.CATEGORY_BACKGROUND);

        ResearchItem researchTallowGolem =
                PseudoResearchItem.create("GOLEMTALLOW", 0, -5).registerResearchItem();
        ...
        RegisteredResearches.researchGolemSilverwood = new SimpleResearchItem(
                ...
                .setParents(researchTallowGolem.key)
                .setConcealed()
                .setPages(
        ...
        RegisteredResearches.researchGolemRunicShield = new SimpleResearchItem(
                        ...
                        new AspectList()
                                ...
                                .add(Aspect.MAGIC, 4)
                                .add(Aspect.MOTION, 8))
                .setParents(RegisteredResearches.researchGolemSilverwood.key)
                .setConcealed()
                .setPages(
        ...
        ResearchItem researchBellows =
                PseudoResearchItem.create("BELLOWS", -2, -5).registerResearchItem();
        ...
        RegisteredResearches.researchArcaneDropper = new SimpleResearchItem(
                ...
                .setParents("DISTILESSENTIA", researchBellows.key)
                .setConcealed()
                .setPages(
        ...
        ResearchItem researchHarvestGather =
                PseudoResearchItem.create("COREHARVEST", 2, -6).registerResearchItem();
        ResearchItem researchCoreGuard =
                PseudoResearchItem.create("COREGUARD", 4, -5).registerResearchItem();
        ...
        ResearchItem researchVEleToolShovel =
                new ResearchItem("ELEMENTALSHOVEL", Gadomancy.MODID).registerResearchItem();
        ...
        ResearchItem researchVBootsTraveller =
                new ResearchItem("BOOTSTRAVELLER", Gadomancy.MODID).registerResearchItem();
        ...
        ResearchItem researchItemVoidMetal =
                PseudoResearchItem.create("VOIDMETAL", -8, -6).registerResearchItem();
        ResearchItem researchWandPedestal =
                PseudoResearchItem.create("WANDPED", -9, -8).registerResearchItem();
        ...
        ResearchItem researchOculus = PseudoResearchItem.create("OCULUS", -11, -2)
                .setRound()
                .setSpecial()
                .registerResearchItem();
        ...
        RegisteredResearches.researchFamiliarAugmentDamage = new IfAnyParentResearchItem(
                ...
                .setConcealed()
                .setParents(RegisteredResearches.researchEtherealFamiliar.key, "VOIDMETAL")
                .setPages(
        ...
        if (ModConfig.ancientStoneRecipes)
            RegisteredResearches.researchAncientStones = new AlternatingResearchItem(
                            "ANCIENT_STONES",
                            -12,
                            1,
                            3,
        ...
        RegisteredResearches.researchAuraPylon = new SimpleResearchItem(
                ...
                .setItemTriggers(
                        new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.FIRE.ordinal()))
                .setPages(
        ...
        RegisteredResearches.researchAuraEffects = new SimpleResearchItem(
                ...
                .setConcealed()
                .setSecondary()
                .setParents(RegisteredResearches.researchAuraPylon.key)
                .setPages(new ResearchPage("gadomancy.research_page.AURA_EFFECTS.1"))
                .registerResearchItem();
        ...
        RegisteredResearches.researchKnowledgeBook = new SimpleResearchItem(
                ...
                .setItemTriggers(
                        new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.ORDER.ordinal()))
                .setPages(
        ...
        ResearchItem researchVReservoir =
                PseudoResearchItem.create("ESSENTIARESERVOIR", -5, 9).registerResearchItem();
        ...
        RegisteredResearches.researchEssentiaCompressor = new SimpleResearchItem(
                ...
                .setItemTriggers(
                        new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.WATER.ordinal()))
                .setPages(
        ...
        ResearchItem researchInfusionEnch =
                PseudoResearchItem.create("INFUSIONENCHANTMENT", -1, 2).registerResearchItem();
    ...
    public static void postInit() {
        ...
        RegisteredResearches.researchStickyJar = new StickyJarResearchItem(
                ...
                .setParents(researchJar.key)
                .setConcealed()
                .setPages(new ResearchPage("gadomancy.research_page.STICKYJAR.1"), page)
                .registerResearchItem();
        ...
        String[] parents =
                Config.allowMirrors ? new String[] {researchJar.key, "MIRRORESSENTIA"} : new String[] {researchJar.key};
