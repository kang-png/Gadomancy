...
public class RegisteredResearches {
    ...
    public static void init() {
        ...
        ResearchCategories.registerCategory(
                Gadomancy.MODID,
                RegisteredResearches.CATEGORY_ICON,
                RegisteredResearches.CATEGORY_BACKGROUND);

        ResearchItem researchTallowGolem = PseudoResearchItem.create("GOLEMTALLOW", 0, -5).registerResearchItem();

        RegisteredResearches.researchGolemSilverwood = new SimpleResearchItem(
                "GOLEMSILVERWOOD",
                1,
                -2,
                3,
                (ItemStack) RegisteredRecipes.recipeGolemSilverwood.getRecipeOutput(),
                new AspectList().add(Aspect.MOTION, 10).add(Aspect.TREE, 10).add(Aspect.MAGIC, 8).add(Aspect.ORDER, 8)
                        .add(Aspect.FLESH, 6).add(Aspect.EXCHANGE, 5)).setParents(researchTallowGolem.key)
                                .setConcealed()
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.GOLEMSILVERWOOD.1"),
                                        new ResearchPage(RegisteredRecipes.recipeGolemSilverwood))
        ...
        RegisteredResearches.researchGolemRunicShield = new SimpleResearchItem(
                ...
                new AspectList().add(Aspect.AURA, 16).add(Aspect.ARMOR, 6).add(Aspect.MAGIC, 4).add(Aspect.MOTION, 8))
                        ...
                        .setPages(
                                ...
                                new ResearchPage(RegisteredRecipes.recipesGolemRunicShield))
                        .registerResearchItem();

        ResearchItem researchBellows = PseudoResearchItem.create("BELLOWS", -2, -5).registerResearchItem();

        RegisteredResearches.researchArcaneDropper = new SimpleResearchItem(
                "ARCANEDROPPER",
                -1,
                -3,
                2,
        ...
        RegisteredResearches.researchInfusionClaw = new SimpleResearchItem(
                "INFUSIONCLAW",
                -6,
                -7,
                5,
                ...
                new AspectList().add(Aspect.ELDRITCH, 8).add(Aspect.MECHANISM, 8).add(Aspect.MAGIC, 8)
                        .add(Aspect.ORDER, 8).add(Aspect.DARKNESS, 4))
                                ...
                                .setPages(
                                        ...
                                        new ResearchPage("gadomancy.research_page.INFUSIONCLAW.2"))
                                .registerResearchItem();

        RegisteredResearches.researchNodeManipulator = new SimpleResearchItem(
                "NODE_MANIPULATOR",
                -9,
                -4,
                2,
                ...
                new AspectList().add(Aspect.ELDRITCH, 8).add(Aspect.AURA, 6).add(Aspect.DARKNESS, 4)
                        ...
                        .add(Aspect.EXCHANGE, 4))
                                ...
                                .setPages(
                                        ...
                                        new ResearchPage("gadomancy.research_page.NODE_MANIPULATOR.3"),
                                        new ResearchPage(RegisteredRecipes.recipeRandomizationFocus),
                                        new ResearchPage(RegisteredRecipes.multiblockNodeManipulator),
                                        new ResearchPage("gadomancy.research_page.NODE_MANIPULATOR.6"))
                                .registerResearchItem();

        RegisteredResearches.researchEldritchPortalCreator = new SimpleResearchItem(
                "E_PORTAL_CREATOR",
                -10,
                0,
                2,
                new ItemStack(RegisteredBlocks.blockAdditionalEldrichPortal, 1, 0),
                new AspectList().add(Aspect.ELDRITCH, 6).add(Aspect.DARKNESS, 10).add(Aspect.TRAVEL, 8)
                        .add(Aspect.AURA, 10).add(Aspect.VOID, 6).add(Aspect.MECHANISM, 4)).setConcealed().setSpecial()
                                .setParents(RegisteredResearches.researchNodeManipulator.key, researchOculus.key)
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.E_PORTAL_CREATOR.1"),
                                        new ResearchPage(RegisteredRecipes.recipeAncientPedestal),
                                        new ResearchPage("gadomancy.research_page.E_PORTAL_CREATOR.3"),
                                        new ResearchPage("gadomancy.research_page.E_PORTAL_CREATOR.4"),
                                        new ResearchPage(RegisteredRecipes.recipePortalFocus),
                                        new ResearchPage("gadomancy.research_page.E_PORTAL_CREATOR.6"),
                                        new ResearchPage(RegisteredRecipes.multiblockEldritchPortalCreator),
                                        new ResearchPage("gadomancy.research_page.E_PORTAL_CREATOR.8"))
                                .registerResearchItem();

        RegisteredResearches.researchBlockProtector = new SimpleResearchItem(
                "BLOCK_PROTECTOR",
                -6,
                -2,
                2,
                new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 2),
                new AspectList().add(Aspect.ORDER, 10).add(Aspect.ARMOR, 8).add(Aspect.EARTH, 12).add(Aspect.LIGHT, 10)
                        .add(Aspect.AURA, 8))
                                .setConcealed()
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.BLOCK_PROTECTOR.1"),
                                        new ResearchPage(RegisteredRecipes.recipeBlockProtector),
        ...
        RegisteredResearches.researchEtherealFamiliar = new SimpleResearchItem(
                "ETHEREAL_FAMILIAR",
                5,
                1,
                2,
        ...
        RegisteredResearches.researchFamiliarElementLightning = new SimpleResearchItem(
                ...
                -1,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Lightning.png"),
                new AspectList().add(Aspect.WEATHER, 4).add(Aspect.WEAPON, 4).add(Aspect.AIR, 8)).setConcealed()
                        .setParents(RegisteredResearches.researchEtherealFamiliar.key)
                        .setPages(
                                new ResearchPage("gadomancy.research_page.FAMILIAR_SHOCK.1"),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[0]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[1]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[2]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarElementFire = new SimpleResearchItem(
                "FAMILIAR_FIRE",
                6,
                -1,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Fire.png"),
                new AspectList().add(Aspect.FIRE, 8).add(Aspect.WEAPON, 4).add(Aspect.MAGIC, 4)).setConcealed()
                        .setParents(RegisteredResearches.researchEtherealFamiliar.key)
                        .setPages(
                                new ResearchPage("gadomancy.research_page.FAMILIAR_FIRE.1"),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[3]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[4]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[5]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarElementPoison = new SimpleResearchItem(
                "FAMILIAR_POISON",
                3,
                2,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Poison.png"),
                new AspectList().add(Aspect.POISON, 8).add(Aspect.WEAPON, 4).add(Aspect.ENTROPY, 4)).setConcealed()
                        .setParents(RegisteredResearches.researchEtherealFamiliar.key)
                        .setPages(
                                new ResearchPage("gadomancy.research_page.FAMILIAR_POISON.1"),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[6]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[7]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[8]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarElementWeakness = new SimpleResearchItem(
                "FAMILIAR_WEAKNESS",
                2,
                0,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Enervation.png"),
                new AspectList().add(Aspect.TRAP, 8).add(Aspect.WEAPON, 8).add(Aspect.TAINT, 6)).setConcealed()
                        .setParents(RegisteredResearches.researchEtherealFamiliar.key)
                        .setPages(
                                new ResearchPage("gadomancy.research_page.FAMILIAR_WEAKNESS.1"),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[9]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[10]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[11]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarAugmentDamage = new IfAnyParentResearchItem(
                "FAMILIAR_DAMAGE",
                8,
                2,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Damage.png"),
                new AspectList().add(Aspect.WEAPON, 8).add(Aspect.ENERGY, 8).add(Aspect.MAGIC, 4))
                        .setAnyParents(
                                RegisteredResearches.researchFamiliarElementFire.key,
                        ...
                        .setPages(
                                ...
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[13]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[14]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarAugmentRange = new IfAnyParentResearchItem(
                "FAMILIAR_RANGE",
                6,
                4,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Range.png"),
                new AspectList().add(Aspect.MAGIC, 8).add(Aspect.ELDRITCH, 8).add(Aspect.ORDER, 4))
                        ...
                        .setPages(
                                new ResearchPage("gadomancy.research_page.FAMILIAR_RANGE.1"),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[15]),
                                new ResearchPage(RegisteredRecipes.recipesFamiliarAugmentation[16]))
                        .registerResearchItem();

        RegisteredResearches.researchFamiliarAugmentSpeed = new SimpleResearchItem(
                "FAMILIAR_SPEED",
                8,
                5,
                2,
                new ResourceLocation("gadomancy", "textures/misc/Fam_Speed.png"),
        ...
        if (ModConfig.enableAdditionalNodeTypes) {
            RegisteredResearches.researchGrowingNodes = new SimpleResearchItem(
                    "GROWING",
                    -8,
                    -1,
                    5,
                    new ResourceLocation("thaumcraft", "textures/misc/r_nodes.png"),
                    new AspectList()).setSpecial().setLost().setConcealed()
                            .setParents(Gadomancy.MODID.toUpperCase() + ".NODE_MANIPULATOR")
                            .setPages(
                                    new ResearchPage("gadomancy.research_page.GROWING.1"),
                                    new ResearchPage("gadomancy.research_page.GROWING.2"))
                            .registerResearchItem();

            RegisteredResearches.researchGrowingNodeAgression = new SimpleResearchItem(
                    "GROWING_AGGRESSION",
                    -5,
                    0,
                    6,
                    new ItemStack(ConfigBlocks.blockAiry, 1, 5),
                    new AspectList()).setLost().setParents(Gadomancy.MODID.toUpperCase() + ".GROWING")
                            .setPages(new ResearchPage("gadomancy.research_page.GROWING_AGGRESSION.1"))
                            .registerResearchItem();

            RegisteredResearches.researchGrowingNodeGrowth = new SimpleResearchItem(
                    "GROWING_GROWTH",
                    -7,
                    2,
                    6,
                    new ResourceLocation("gadomancy", "textures/misc/r_node_star.png"),
                    new AspectList())
                            .setLost().setParents(Gadomancy.MODID.toUpperCase() + ".GROWING")
                            .setPages(
                                    new ResearchPage("gadomancy.research_page.GROWING_GROWTH.1"),
                                    new ResearchPage("gadomancy.research_page.GROWING_GROWTH.2"))
                            .registerResearchItem();

            RegisteredResearches.researchGrowingNodeAttackNodes = new SimpleResearchItem(
                    "GROWING_ATTACK",
                    -6,
                    1,
                    6,
                    new ResourceLocation("gadomancy", "textures/misc/r_node_dark.png"),
                    new AspectList()).setLost().setParents(Gadomancy.MODID.toUpperCase() + ".GROWING")
                            .setPages(new ResearchPage("gadomancy.research_page.GROWING_ATTACK.1"))
                            .registerResearchItem();

            RegisteredResearches.researchGrowingNodeGrowthClue = new SimpleResearchItem(
                    "GROWING_GROWTHCLUE",
                    -4,
                    3,
                    2,
                    new ItemStack(ConfigBlocks.blockAiry, 1, 5),
                    new AspectList().add(Aspect.AURA, 10).add(Aspect.MAGIC, 15).add(Aspect.ELDRITCH, 5)
                            .add(Aspect.VOID, 12).add(Aspect.ENERGY, 12).add(Aspect.ENTROPY, 8).add(Aspect.DEATH, 3)
                            .add(Aspect.GREED, 10).add(Aspect.HUNGER, 10).add(Aspect.MECHANISM, 12)
                            .add(Aspect.DARKNESS, 12))
                                    ...
                                    .setPages(
                                            new ResearchPage("gadomancy.research_page.GROWING_GROWTHCLUE.1"),
                                            new ResearchPage("gadomancy.research_page.GROWING_GROWTHCLUE.2"))
                                    .registerResearchItem();
        }

        if (ModConfig.ancientStoneRecipes) RegisteredResearches.researchAncientStones = new AlternatingResearchItem(
                "ANCIENT_STONES",
                -12,
                1,
                3,
                new AspectList().add(Aspect.ELDRITCH, 10).add(Aspect.EARTH, 8).add(Aspect.EXCHANGE, 6)
                        .add(Aspect.ENTROPY, 8),
                new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 11),
                new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 15))
                        .setConcealed().setParents(researchOculus.key)
                        .setPages(
        ...
        RegisteredResearches.researchAuraCore = new AlternatingResearchItem(
                "AURA_CORE",
                -1,
                6,
                2,
                ...
                cores).setConcealed().setSpecial().setParents("INFUSION", "THAUMIUM")
                        .setPages(
                                ...
                                new ResearchPage("gadomancy.research_page.AURA_CORE.3"),
                                new MultiResearchPage(RegisteredRecipes.auraCoreRecipes))
                        .registerResearchItem();

        RegisteredResearches.researchCleanAuraCore = new SimpleResearchItem(
                "CLEAN_AURA_CORE",
                1,
                5,
                0,
                ...
                new AspectList().add(Aspect.HEAL, 8).add(Aspect.AURA, 6).add(Aspect.MAGIC, 8).add(Aspect.WATER, 10))
                        .setConcealed().setSecondary().setParents(RegisteredResearches.researchAuraCore.key)
                        .setPages(
                                new ResearchPage("gadomancy.research_page.CLEAN_AURA_CORE.1"),
                                new ResearchPage(RegisteredRecipes.recipesWashAuraCore),
                                new ResearchPage(RegisteredRecipes.recipesUndoAuraCore))
                        .registerResearchItem();

        RegisteredResearches.researchAuraPylon = new SimpleResearchItem(
                "AURA_PYLON",
                0,
                9,
                2,
                        ...
                        .add(Aspect.MECHANISM, 8)).setHidden()
                                ...
                                .setItemTriggers(
                                        new ItemStack(
                                                ...
                                                1,
                                                ItemAuraCore.AuraCoreType.FIRE.ordinal()))
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.AURA_PYLON.1"),
                                        new ResearchPage(RegisteredRecipes.recipeAuraPylon),
                                        new ResearchPage(RegisteredRecipes.recipeAuraPylonPeak),
                                        new ResearchPage("gadomancy.research_page.AURA_PYLON.4"),
                                        new ResearchPage(RegisteredRecipes.multiblockAuraPylon))
                                .registerResearchItem();

        RegisteredResearches.researchAuraEffects = new SimpleResearchItem(
                "AURA_EFFECTS",
                1,
                10,
                2,
                ...
                new AspectList().add(Aspect.AURA, 6).add(Aspect.MIND, 8).add(Aspect.MAGIC, 4).add(Aspect.ORDER, 4))
                        .setConcealed().setSecondary().setParents(RegisteredResearches.researchAuraPylon.key)
                        .setPages(new ResearchPage("gadomancy.research_page.AURA_EFFECTS.1")).registerResearchItem();

        RegisteredResearches.researchKnowledgeBook = new SimpleResearchItem(
                "KNOWLEDGE_BOOK",
                -2,
                8,
                2,
                        ...
                        .add(Aspect.MECHANISM, 8).add(Aspect.CRAFT, 8)).setHidden()
                                ...
                                .setItemTriggers(
                                        new ItemStack(
                                                RegisteredItems.itemAuraCore,
                                                1,
                                                ItemAuraCore.AuraCoreType.ORDER.ordinal()))
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.KNOWLEDGE_BOOK.1"),
                                        new ResearchPage(RegisteredRecipes.recipeKnowledgeBook),
                                        new ResearchPage("gadomancy.research_page.KNOWLEDGE_BOOK.3"),
                                        new ResearchPage("gadomancy.research_page.KNOWLEDGE_BOOK.4"))
                                .registerResearchItem();

        ResearchItem researchVReservoir = PseudoResearchItem.create("ESSENTIARESERVOIR", -5, 9).registerResearchItem();

        RegisteredResearches.researchEssentiaCompressor = new SimpleResearchItem(
                "ESSENTIA_COMPRESSOR",
                -4,
                7,
                2,
                ...
                new AspectList().add(Aspect.VOID, 12).add(Aspect.WATER, 10).add(Aspect.ENTROPY, 12).add(Aspect.MAGIC, 6)
                        .add(Aspect.MECHANISM, 12)).setHidden()
                                .setParents(RegisteredResearches.researchAuraCore.key, researchVReservoir.key)
                                .setItemTriggers(
                                        new ItemStack(
                                                RegisteredItems.itemAuraCore,
                                                1,
                                ...
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.ESSENTIA_COMPRESSOR.1"),
         ...
         * ItemStack(RegisteredBlocks.blockStoneMachine, 1, 5), new AspectList().add(Aspect.MIND,
         * 10).add(Aspect.ENTROPY, 20).add(Aspect.AURA, 12).add(Aspect.BEAST, 16).add(Aspect.MECHANISM, 12))
         * .setHidden() .setParents(researchAuraCore.key, "ROD_greatwood") .setItemTriggers(new
         * ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.EARTH.ordinal())) .setPages(new
         * ResearchPage("gadomancy.research_page.AI_SHUTDOWN.1"), new ResearchPage(RegisteredRecipes.recipeAiShutdown))
         * .registerResearchItem();
         */

        String[] packagerParents = Config.wardedStone
                ? new String[] { RegisteredResearches.researchAuraCore.key, "WARDEDARCANA" }
                : new String[] { RegisteredResearches.researchAuraCore.key };
        RegisteredResearches.researchArcanePackager = new SimpleResearchItem(
                "ARCANE_PACKAGER",
                2,
                7,
                2,
                new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 4),
                new AspectList().add(Aspect.AIR, 12).add(Aspect.MECHANISM, 16).add(Aspect.VOID, 10)
                        .add(Aspect.MAGIC, 10)).setHidden().setParents(packagerParents).setItemTriggers(
                                new ItemStack(RegisteredItems.itemAuraCore, 1, ItemAuraCore.AuraCoreType.AIR.ordinal()))
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.ARCANE_PACKAGER.1"),
                                        new ResearchPage(RegisteredRecipes.recipeArcanePackager),
                                        new ResearchPage("gadomancy.research_page.ARCANE_PACKAGER.3"),
                                        new ResearchPage("gadomancy.research_page.ARCANE_PACKAGER.4"))
                                .registerResearchItem();

        ResearchItem researchInfusionEnch = PseudoResearchItem.create("INFUSIONENCHANTMENT", -1, 2)
                .registerResearchItem();

        ItemStack goggles = new ItemStack(ConfigItems.itemGoggles);
        goggles.addEnchantment(Enchantment.protection, 1);
        RegisteredResearches.researchRevealer = new SimpleResearchItem(
                "REVEALER",
                1,
                3,
                1,
        ...
        RegisteredResearches.researchArmorDisguise = new DisguiseResearchItem(
                "ARMORDISGUISE",
                -2,
                0,
                1,
                new AspectList().add(Aspect.SLIME, 8).add(Aspect.MAGIC, 4).add(Aspect.ARMOR, 4))
                        .setParents(researchInfusionEnch.key).setConcealed()
                        .setPages(
                                new ResearchPage("gadomancy.research_page.ARMORDISGUISE.1"),
                                new ResearchPage(new InfusionVisualDisguiseArmor(false)),
                                new ResearchPage(new InfusionVisualDisguiseArmor(true)),
                                new ResearchPage("gadomancy.research_page.ARMORDISGUISE.4"))
                        .registerResearchItem();
    ...
    public static void postInit() {
        ...
        RegisteredResearches.researchStickyJar = new StickyJarResearchItem(
                "STICKYJAR",
                -5,
                -5,
                2,
                new AspectList().add(Aspect.SLIME, 8).add(Aspect.EARTH, 8)).setParents(researchJar.key).setConcealed()
                        .setPages(new ResearchPage("gadomancy.research_page.STICKYJAR.1"), page).registerResearchItem();

        if (RegisteredResearches.researchBlockProtector != null) {
            RegisteredResearches.researchBlockProtector.setParents(RegisteredResearches.researchStickyJar.key);
        }

        String[] parents = Config.allowMirrors ? new String[] { researchJar.key, "MIRRORESSENTIA" }
                : new String[] { researchJar.key };
        RegisteredResearches.researchRemoteJar = new SimpleResearchItem(
                "REMOTEJAR",
                -4,
                -3,
                3,
                RegisteredRecipes.recipeRemoteJar.getRecipeOutput(),
                new AspectList().add(Aspect.WATER, 4).add(Aspect.MECHANISM, 8).add(Aspect.EARTH, 4)
                        .add(Aspect.ORDER, 8))
                                .setParents(parents).setConcealed()
                                .setPages(
                                        new ResearchPage("gadomancy.research_page.REMOTEJAR.1"),
                                        new ResearchPage(RegisteredRecipes.recipeRemoteJar),
                                        new ResearchPage("gadomancy.research_page.REMOTEJAR.2"))
                                .registerResearchItem();
