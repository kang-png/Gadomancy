...
public class RegisteredRecipes {
    ...
    public static void init() {
        ...
        RegisteredRecipes.recipeArcaneDropper = ThaumcraftApi.addArcaneCraftingRecipe(
                SimpleResearchItem.getFullName("ARCANEDROPPER"),
                new ItemStack(RegisteredBlocks.blockArcaneDropper),
                new AspectList().add(Aspect.ORDER, 14).add(Aspect.AIR, 14).add(Aspect.EARTH, 10),
                "SDS",
                "BAB",
                "SSS",
                'S',
        ...
        RegisteredRecipes.recipeGolemCoreBreak = ThaumcraftApi.addInfusionCraftingRecipe(
                SimpleResearchItem.getFullName("GOLEMCOREBREAK"),
        ...
        RegisteredRecipes.recipeRemoteJar = ThaumcraftApi.addArcaneCraftingRecipe(
                ...
                new ItemStack(RegisteredBlocks.blockRemoteJar),
        ...
        RegisteredRecipes.multiblockNodeManipulator = Arrays.asList(
                ...
                Arrays.asList(
                        ...
                        null,
                        null,
                        new ItemStack(RegisteredBlocks.blockNode, 1, 5),
                        null,
                        null,
                        null,
                        null,
        ...
        RegisteredRecipes.multiblockEldritchPortalCreator = Arrays.asList(
                ...
                Arrays.asList(
                        ...
                        null,
                        null,
                        new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 1),
                        null,
                        null,
                        null,
                        null,
        ...
        RegisteredRecipes.multiblockAuraPylon = Arrays.asList(
        ...
        RegisteredRecipes.recipeGolemCoreBodyguard = ThaumcraftApi.addInfusionCraftingRecipe(
        ...
        RegisteredRecipes.recipeBlockProtector[0] = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".BLOCK_PROTECTOR",
        ...
        RegisteredRecipes.recipeBlockProtector[1] = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".BLOCK_PROTECTOR",
                new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 2),
                new AspectList().add(Aspect.ORDER, 120).add(Aspect.EARTH, 120),
                "WNW",
        ...
        RegisteredRecipes.recipeBlockProtector[2] = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".BLOCK_PROTECTOR",
                new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 2),
                new AspectList().add(Aspect.ORDER, 120).add(Aspect.EARTH, 120),
                "WNV",
                ...
                'R',
                new ItemStack(Items.redstone));
        RegisteredRecipes.recipeBlockProtector[3] = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".BLOCK_PROTECTOR",
                new ItemStack(RegisteredBlocks.blockStoneMachine, 1, 2),
                new AspectList().add(Aspect.ORDER, 120).add(Aspect.EARTH, 120),
                "WNV",
        ...
        if (ModConfig.ancientStoneRecipes) {
            RegisteredRecipes.recipeAncientStone = ThaumcraftApi.addArcaneCraftingRecipe(
                    Gadomancy.MODID.toUpperCase() + ".ANCIENT_STONES",
                    new ItemStack(ConfigBlocks.blockCosmeticSolid, 4, 11),
                    new AspectList().add(Aspect.ENTROPY, 16).add(Aspect.EARTH, 8),
                    "SSS",
                    "SES",
                    "SSS",
                    'S',
            ...
            RegisteredRecipes.recipeAncientStonePedestal = ThaumcraftApi.addCrucibleRecipe(
                    Gadomancy.MODID.toUpperCase() + ".ANCIENT_STONES",
                    new ItemStack(ConfigBlocks.blockCosmeticSolid, 1, 15),
        ...
        for (int i = 1; i < auraCoreTypes.length; i++) {
            RegisteredRecipes.recipesWashAuraCore[i - 1] = ThaumcraftApi.addCrucibleRecipe(
        ...
        RegisteredRecipes.recipeAuraCore = ThaumcraftApi.addInfusionCraftingRecipe(
        ...
        RegisteredRecipes.recipeAuraPylonPeak = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".AURA_PYLON",
                new ItemStack(RegisteredBlocks.blockAuraPylon, 1, 1),
        ...
        RegisteredRecipes.recipeArcanePackager = ThaumcraftApi.addArcaneCraftingRecipe(
                Gadomancy.MODID.toUpperCase() + ".ARCANE_PACKAGER",
        ...
        RegisteredRecipes.recipeElementVoid = ThaumcraftApi.addInfusionCraftingRecipe(
        ...
        RegisteredRecipes.recipeRevealer = ThaumcraftApi.addInfusionEnchantmentRecipe(
                Gadomancy.MODID.toUpperCase() + ".REVEALER",
    ...
    public static InfusionRecipe[] createFamiliarRecipes() {
        ...
        for (int i = 0; i < aspects.size(); i++) {
            ...
            recipes[i] = ThaumcraftApi.addInfusionCraftingRecipe(
