 ...
 *
 * Original created by Azanor@Thaumcraft: thaumcraft.common.blocks.BlockJar Modified to create compatibility with
 * ExtendedNodes Created by HellFirePvP @ 25.10.2015 22:02
 */
public class BlockExtendedNodeJar extends BlockContainer {
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune) {
        ...
        if ((te != null) && ((te instanceof TileExtendedNodeJar))
            ...
            ((ItemExtendedNodeJar) drop.getItem()).setNodeAttributes(
                    drop,
