...
public class RemoteJarProvider implements IWailaDataProvider {
    ...
    @Override
    public List<String> getWailaHead(ItemStack stack, List<String> strings, IWailaDataAccessor dataAccessor,
            IWailaConfigHandler iWailaConfigHandler) {
        return null;
    }

    @Override
    public List<String> getWailaBody(ItemStack stack, List<String> strings, IWailaDataAccessor dataAccessor,
            IWailaConfigHandler iWailaConfigHandler) {
    ...
    @Override
    public List<String> getWailaTail(ItemStack stack, List<String> strings, IWailaDataAccessor dataAccessor,
            IWailaConfigHandler iWailaConfigHandler) {
        return null;
    }

    @Override
    public NBTTagCompound getNBTData(EntityPlayerMP entityPlayerMP, TileEntity tileEntity, NBTTagCompound compound,
            World world, int i, int i2, int i3) {
        return null;
    }
}
