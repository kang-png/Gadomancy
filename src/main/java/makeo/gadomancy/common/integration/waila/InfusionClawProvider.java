...
public class InfusionClawProvider implements IWailaDataProvider {
    ...
    @Override
    public List<String> getWailaBody(ItemStack paramItemStack, List<String> strings, IWailaDataAccessor dataAccessor,
            IWailaConfigHandler paramIWailaConfigHandler) {
    ...
    @Override
    public List<String> getWailaTail(ItemStack paramItemStack, List<String> paramList, IWailaDataAccessor dataAccessor,
            IWailaConfigHandler paramIWailaConfigHandler) {
        return null;
    }
