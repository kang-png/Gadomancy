...
public class AdvancedGolemProvider implements IWailaEntityProvider {
    ...
    @Override
    public List<String> getWailaHead(Entity paramEntity, List<String> strings, IWailaEntityAccessor data,
            IWailaConfigHandler config) {
        return null;
    }

    @Override
    public List<String> getWailaBody(Entity paramEntity, List<String> strings, IWailaEntityAccessor data,
            IWailaConfigHandler config) {
        return null;
    }

    @Override
    public List<String> getWailaTail(Entity paramEntity, List<String> strings, IWailaEntityAccessor data,
            IWailaConfigHandler config) {
        if (data.getEntity() instanceof EntityGolemBase) {
            AdditionalGolemType type = GadomancyApi
                    .getAdditionalGolemType(((EntityGolemBase) data.getEntity()).getGolemType());
