...
/**
 * HellFirePvP@Admin Date: 19.04.2016 / 14:51 on Gadomancy ItemBlockKnowledgeBook
 */
public class ItemBlockKnowledgeBook extends ItemBlock {
    ...
    public boolean onItemUse(ItemStack stack, EntityPlayer player, World world, int x, int y, int z, int side,
        ...
        if (placedAgainstDir.equals(ForgeDirection.UP) && placedAgainst.equals(ConfigBlocks.blockStoneDevice)
                && againstMeta == 1) {
